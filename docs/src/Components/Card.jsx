...
function Card({ data, reference }) {
   return (
      ...
      dragElastic={.1}  dragTransition={{ bounceStiffness: 100, bounceDamping: 30 }}
      className='relative flex-shrink-0 w-60 h-72 rounded-[45px] bg-zinc-900/90 text-white px-8 py-10 overflow-hidden'>
         ...
         <div className='footer absolute bottom-0  w-full  left-0'>
            ...
            { 
               data.tag.isOpen && (
                  <div className={`tag w-full py-4 bg-${data.tag.tagColor === "blue" ? "bg-blue-600" : "bg-green-600" } flex items-center justify-center`}>
